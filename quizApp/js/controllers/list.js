...
angular
    .module('Quiz')
    .controller('listCtrl', ['$log','quizMatrix',function($log,quizMatrix){
        var list = this;
...
//        },
        ...
        list.data = turtlesData;
        
        list.activeTurtle = {};
        
        list.changeTurtle = function(obj) {
            list.activeTurtle = obj;
        };
        
        list.quizMatrix = quizMatrix;
        
        $log.log(list.quizMatrix);
        
        //list.quizStarted = quizMatrix.quizActive;
        
        list.activateQuiz = function() {
            
            list.quizMatrix.quizActive = !list.quizMatrix.quizActive;
        };
